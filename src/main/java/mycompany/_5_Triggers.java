...
//      Name and Group
// When a trigger group (part of identity) is not specified, the trigger's group becomes the default group.
// When a trigger's name (part of identity) is not specified, the trigger's name is randomly generated by Quartz.

//      Schedule
// A trigger without a schedule associated with it will fire only once upon it's startAt time
...
public class _5_Triggers {
    ...
    // if a startAt date is not given (if the line was omitted), "now" is implied
    ...
    // A trigger with no name or group - it acquires random name and the default group
    // Example of <group.name> is "DEFAULT.6da64b5bd2ee-70d5d7c8-2040-4955-8c5b-09ba99bb10c5"
    public static Trigger triggerWithNoNameOrGroup() {
        return TriggerBuilder.newTrigger()
                .build();
    }
